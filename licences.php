...
$all_licences = [
    "kuralai.net"=> "545487878"
    ];
    

if($domain && $licence && @$all_licences[$domain] == $licence){
...
<div class="message-box">
  <h1>Need License!</h1>
  <p>It seems that you are using these resources without obtaining a license or permission from the owner. You must obtain a license so that this page does not appear here again!</p>
